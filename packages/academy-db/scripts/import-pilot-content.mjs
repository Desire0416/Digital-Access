// Importe le contenu généré des formations pilotes (prisma/content/pilot-formations.json)
// dans la base dédiée Academy : fiche + modules → leçons (markdown) → quiz notés.
// Idempotent (reconstruit le curriculum des formations concernées). Publie les formations.
//   node --env-file=../../.env scripts/import-pilot-content.mjs
...
const formations = JSON.parse(readFileSync(join(__dirname, "..", "prisma", "content", "pilot-formations.json"), "utf8"));
...
console.log("=== IMPORT PILOTE TERMINÉ ===");
