    ...
    <div className="relative">
      ...
      >
        ...
        <p className="mx-auto mt-3 max-w-sm leading-relaxed text-text-secondary">
          Votre adresse email est confirmée. Vous avez désormais accès à
          l'ensemble de votre espace Digital Access.
        </p>
...
export function VerifyError() {
  return (
    ...
    >
      ...
      <p className="mx-auto mt-3 max-w-sm leading-relaxed text-text-secondary">
        Ce lien de confirmation n'est plus valable. Les liens expirent après 24
        heures pour votre sécurité. Demandez-en un nouveau ci-dessous.
      </p>
