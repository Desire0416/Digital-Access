...
/**
 * Décor de hero : dégradés animés (aurora), formes organiques et grille subtile.
 * Jamais un fond blanc plat — c'est la signature visuelle anti-générique.
 */
export function HeroBackground({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute -left-24 top-[-10%] h-[32rem] w-[32rem] rounded-full bg-brand-violet/25 blur-[120px]"
