    ...
    >
      <div className="mb-8">
        ...
        <p className="mt-2.5 text-text-secondary">
          Créez votre compte apprenant en quelques secondes — accédez au
          catalogue et aux chapitres gratuits, sans engagement.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        ...
        <p className="text-xs leading-relaxed text-text-muted">
          ...
          <a
            href="https://digitalaccess.ci/cgu"
            target="_blank"
          ...
          et la{" "}
          <a
            href="https://digitalaccess.ci/confidentialite"
            target="_blank"
            rel="noopener noreferrer"
            className="font-medium text-brand-blue-royal hover:text-brand-violet"
          >
