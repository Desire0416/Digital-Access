...
export const metadata: Metadata = {
  ...
  description:
    "Un email de confirmation a été envoyé. Cliquez sur le lien reçu pour activer votre compte Access Academy et commencer à apprendre.",
};
      ...
      <div className="w-full max-w-lg text-center">
        <div className="card-gradient-border rounded-3xl p-8 shadow-brand-lg sm:p-12">
          ...
          <p className="mt-4 leading-relaxed text-text-secondary">
            ...
            sur le lien qu'il contient pour activer votre compte Access Academy
            et débloquer vos premiers cours.
          </p>
