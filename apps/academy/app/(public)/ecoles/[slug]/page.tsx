        ...
        {school.courses.length > 0 && (
          <section>
            <SectionHeading
              ...
              title="Les"
              gradient="formations"
              subtitle="Des formations professionnelles courtes, chacune validée par un projet concret et sanctionnée par un certificat interne. Une formation acquise compte pour chaque parcours qui l'inclut — jamais payée deux fois."
            />
            <StaggerGroup className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
